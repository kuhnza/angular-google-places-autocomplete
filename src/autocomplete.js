(function (window, angular, undefined) { 'use strict';
     ...
     * Updated 2015 "movibe" Willian Ribeiro
    ...
    function gPlacesAutocomplete($compile, $timeout, $document, googlePlacesApi) {
        var google = googlePlacesApi;
        return {
            restrict  : 'A',
            require   : '^ngModel',
            scope     : {
            ...
            link      : function ($scope, element, attrs, controller) {
                ...
                function formatAddress(place) {
                    var address = {
                        ...
                        resume : place.formatted_address,
                        desc   : '',
                        geo    : {
                    ...
                    address.map    = src(address.geo.latitude, address.geo.longitude, 16, 900, 200);
                    return address;
                }
                    ...
                    if (prediction.is_custom) {
                        ...
                        placesService.getDetails({
                            ...
                            if (status == google.maps.places.PlacesServiceStatus.OK) {
                                $scope.$apply(function () {
                                    $scope.model                   = place;
                                    $scope.model                   = formatAddress(place);
                                    $scope.model.formatted_address = place.formatted_address;
                                    console.log('aplicar place', place, formatAddress(place))
